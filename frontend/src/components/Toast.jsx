...
export function Toast({ kind = "info", title, children, onClose, duration }) {
  const palettes = {
    success:
      "bg-emerald-500 border-emerald-600 text-white dark:bg-emerald-500 dark:border-emerald-600",
    error:
      "bg-rose-500 border-rose-600 text-white dark:bg-rose-500 dark:border-rose-600",
    info: "bg-blue-500 border-blue-600 text-white dark:bg-blue-500 dark:border-blue-600",
    warning:
      "bg-amber-500 border-amber-600 text-amber-900 dark:bg-amber-500 dark:border-amber-600",
  };
